Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/jaceconflenti/PhoneNumberKit'
  s.license          = 'MIT'
  s.author           = { 'Jace Conflenti' => 'jace@squaruep.com' }
  s.source           = { git: 'https://github.com/jaceconflenti/PhoneNumberKit.git', tag: s.version.to_s }
  s.resource_bundles  = {'PhoneNumberKit_privacy' => ['PhoneNumberKit/PrivacyInfo.xcprivacy']}
  ...
  s.subspec 'PhoneNumberKitCore' do |core|
    ...
    core.watchos.deployment_target = '5.2'
